...
void Shop::SetItems()
{
    // json or csv -> data table -> parsing and use
...
{
    std::cout << "»óÁ¡ ¾ÆÀÌÅÛ ¸ñ·Ï (" << (type == GameEnums::ItemType::ITEM_WEAPON ? "¹«±â" : "¹æ¾î±¸")
        << "): " << std::endl;
    ...
    for (int i = 0; i < items.size(); i++)
    {
        ...
        {
            std::cout << i + 1 << ". " << item.GetName() << " - " << item.GetPrice() << "°ñµå" << std::endl;
        }
    }
}
